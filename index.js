...
// mongoose.connect('mongodb+srv://sumar3115:SeEkR7RyYyg5g8iC@lgswebsite.om6meue.mongodb.net/Lgs?retryWrites=true&w=majority', {
...
//     // if (!name || !email || !phone || !whatsapp || !service || !message) {
//     //   return res.status(400).json({ error: 'All fields are required' });
//     // }
//     if (phoneNumber.length !== 10) {
//       return res.status(400).json({ error: 'Phone  numbers must be 10 digits long' });
//     }
...
//     // Set the filename for the uploaded resume
...
// // Function to send confirmation email to the user
// // Implement the sendConfirmationEmailToUser function similar to the registration API

// // Function to send confirmation email to the admin (HR)
// // Implement the sendConfirmationEmailToAdmin function similar to the registration API
...
//       await Visit.updateOne({}, { $inc: { count: 3 } });
...
// Connect to the MongoDB database
mongoose.connect('mongodb+srv://roy123:ccz2vJe1Nae3NZ4J@lgswebsite.om6meue.mongodb.net/Lgs?retryWrites=true&w=majority', {
  useNewUrlParser: true,
  useUnifiedTopology: true,
})
  .then(() => {
